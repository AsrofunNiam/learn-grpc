...
func (x *CreaUserResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreaUserResponse) ProtoMessage() {}

func (x *CreaUserResponse) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_create_user_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreaUserResponse.ProtoReflect.Descriptor instead.
func (*CreaUserResponse) Descriptor() ([]byte, []int) {
	return file_rpc_create_user_proto_rawDescGZIP(), []int{1}
}

func (x *CreaUserResponse) GetUser() *User {
	if x != nil {
		return x.User
	}
	return nil
...
var file_rpc_create_user_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4d, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x30, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x55, 0x73,
	...
	0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x41, 0x73, 0x72, 0x6f, 0x66, 0x75, 0x6e, 0x4e, 0x69,
	0x61, 0x6d, 0x2f, 0x6c, 0x65, 0x61, 0x72, 0x6e, 0x2d, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x70, 0x62,
...
var file_rpc_create_user_proto_goTypes = []any{
	...
	(*CreaUserResponse)(nil),  // 1: pb.CreaUserResponse
	(*User)(nil),              // 2: pb.User
}
var file_rpc_create_user_proto_depIdxs = []int32{
	2, // 0: pb.CreaUserResponse.user:type_name -> pb.User
