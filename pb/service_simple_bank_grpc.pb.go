...
type SimpleBankServiceClient interface {
	CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreaUserResponse, error)
...
func (c *simpleBankServiceClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreaUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreaUserResponse)
...
type SimpleBankServiceServer interface {
	CreateUser(context.Context, *CreateUserRequest) (*CreaUserResponse, error)
...
func (UnimplementedSimpleBankServiceServer) CreateUser(context.Context, *CreateUserRequest) (*CreaUserResponse, error) {
